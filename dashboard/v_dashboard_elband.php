    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <h5>
          ...
          <h5>
            <?php
              $data = mysqli_query($koneksi, "SELECT DISTINCT elband_personil FROM mon_elband where id = $id");
              $d = mysqli_fetch_assoc($data);
            ?>
        ...
        <table id="dtUser" class="table table-bordered">
          <tbody>
            <?php 
            $sql = "select e.elband_name,me.elband_status,me.elband_keterangan from mon_elband as me inner join elband as e ON e.elband_id = me.elband_id where me.id = $id";
